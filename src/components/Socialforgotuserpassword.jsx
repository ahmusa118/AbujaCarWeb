...
const Socialforgotadminpassword = () => {
    ...
    const resetpassword=async()=>{
        await sendPasswordResetEmail(auth2,email).then(()=>message.success('Password reset email sent. Check spam if not in inbox')).catch(e=>message.error('Something wrong happened'))
    }
  return (
    <div className='m-2'>
